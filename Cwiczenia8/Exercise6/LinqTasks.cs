...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            result = Emps.Where(emp => emp.Job == "Backend programmer");
        ...
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(emp => emp.Salary == Emps.Max(emp2 => emp2.Salary));
            return result;
        }
        ...
        public static IEnumerable<object> Task5()
        {
            ...
            result = Emps.Select(emp => new {Nazwisko = emp.Ename, Praca = emp.Job});
            return result;
        }
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            result = Emps.GroupBy(emp => emp.Job)
                .Select(emp2 => new { Praca = emp2.Key, LiczbaPracownikow = emp2.Count() });
            return result;
        }
        ...
        {
            IEnumerable<object> result = null;
            result = Depts.Select(dept => new
                {
                    dept.Dname,
                    Employees = Emps.Where(emp => emp.Deptno == dept.Deptno).ToList()
                })
                .Where(deptWithEmps => deptWithEmps.Employees.Count > 1)
                .Select(deptWithEmps => new
                {
                    name = deptWithEmps.Dname,
                    numOfEmployees = deptWithEmps.Employees.Count
                });
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = Depts.Where(dept => Emps.Count(emp => emp.Deptno == dept.Deptno) == 5
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> WithMinOneSubordinate(this IEnumerable<Emp> employees)
        {
            return employees
